#!/usr/bin/env sh
# Universal installer for sbomgate. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/sbomgate.git"
echo "Installing sbomgate ..."
